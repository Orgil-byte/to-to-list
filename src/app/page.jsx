    ...
    <div>
      <div className="mt-20  py-6 px-4 w-94.25 min-h-72.5 flex flex-col items-center shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
        ...
        <div className="flex w-86.25 gap-1.5 mb-5">
          <button className="py-1 px-3 h-8 bg-[#F3F4F6] text-[#363636] text-[12px] rounded-sm">
            All
          </button>
          <button className="py-1 px-3 h-8 bg-[#F3F4F6] text-[#363636] text-[12px] rounded-sm">
            Active
        ...
        <TaskInfo renderInput={renderInput} setRenderInput={setRenderInput} />
      </div>
    </div>
  );
};

const TaskInfo = ({ renderInput, setRenderInput }) => {
